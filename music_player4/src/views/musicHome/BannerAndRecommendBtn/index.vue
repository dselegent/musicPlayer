  ...
  <div class="bannerAndRecommendBtn">
    ...
    <div class="dailyRecommend">
      <el-skeleton style="width: 240px" :loading="bannerLoading" animated :throttle="10">
        ...
        <template #default>
          <el-carousel :interval="4000" height="200px" type="card" :autoplay="false">
    ...
    <div class="recommendedButton">
      ...
      <el-button type="warning" round size="large" @click="$router.push('/allSongSheet')">
        歌单
      </el-button>
      <el-button color="#626aef" round size="large" @click="$router.push('/ranking')">
        排行榜
      </el-button>
