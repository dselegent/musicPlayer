<template>
  <main id="musicHome">
    <el-scrollbar ref="scrollbarRef" height="440px">
      <!-- 横幅和推荐按钮 -->
      <BannerAndRecommendBtn :bannerLoading="bannerLoading" :bannerList="bannerList" />
      <!-- 推荐歌单和音乐人排名榜 -->
...
<script setup lang="ts">
  ...
  // 加载状态
  let bannerLoading: boolean = $ref(true)
  let songSheetLoading: boolean = $ref(true)
  let topArtistsLoading: boolean = $ref(true)
