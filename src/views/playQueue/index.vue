              ...
              >
                <template #placeholder>
                  <i
                    ...
                    style="margin-right: 12px; font-size: 40px; color: var(--el-color-info-light-3)"
                  ></i>
                </template>
              </el-image>
              <!-- 歌名 -->
        ...
        <el-table-column label="歌手" sortable align="center" width="150">
          <template #default="{ row }">
            <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap">
              <template v-for="(item, index) in row?.ar" :key="item.id">
...
<script setup lang="ts" name="PlayQueue">
